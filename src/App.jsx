    ...
    <>
      <nav className="navbar navbar-dark bg-dark">
        <div className="container-fluid">
          <a className="navbar-brand" href="/"><span>InVeNtOrY</span></a>
          ...
          <div className="collapse navbar-collapse" id="navbarNav">
            <ul className="navbar-nav">
              ...
              <li className="nav-item">
                <a className="nav-link" href="/">Music Inventory</a>
              </li>
              <li className="nav-item">
                <a className="nav-link" href="/">Sports Inventory</a>
              </li>
              <li className="nav-item">
      ...
      <hr className="my-5" />
      <div className="row g-5 mx-5 border border-secondary my-5 rounded-top col-md-8 mx-auto border-5 shadow-lg">
